...
- **Гибкий просмотр библиотеки** по дате, папкам, местам, камерам, объективам, тегам, оценкам и лицам, со случайной сортировкой и фильтром маленьких изображений.
- **Интерактивная карта** для просмотра фотографий и видео с геометками в группах с учётом текущих фильтров.
- **Умные альбомы** сохраняют представления на основе правил с настраиваемой группировкой и сортировкой.
- **Коллекции и теги** для массовой организации выбранных файлов без перемещения или копирования оригиналов.
- **Локальный ИИ-поиск** по тексту, визуальному сходству, сюжетам и группам лиц, с дополнительным поиском более чем на 50 языках.
- **Apple Live Photos и Google Motion Photos** с воспроизведением движения и общим фильтром в умных альбомах.
- **Пары RAW + JPEG/HEIC** отображаются как один элемент; связанные файлы обрабатываются вместе при файловых операциях.
- **Настраиваемые миниатюры и предпросмотр RAW** на основе обработки RAW или встроенного превью камеры.
- **Работа с папками** с несколькими библиотеками, импортом перетаскиванием или через буфер обмена, синхронизацией и безопасными файловыми операциями.
- **Импорт по дате** в папки по дням, месяцам, годам или в одну папку, с сохранением имён файлов и пропуском дубликатов.
- **Отбор и сравнение** с просмотром изображений в четырёх панелях.
- **Очистка дубликатов** с оценкой освобождаемого места и массовым удалением в нескольких группах.
- **Настраиваемый просмотр** с миниатюрами до 1024 px, размером сетки и формой углов, быстрым просмотром или отдельными окнами.
- **Интеграция с рабочим столом** с несколькими внешними приложениями и установкой обоев в macOS, Windows и GNOME Linux.
- **Встроенный редактор** для обрезки, поворота, отражения, изменения размера и базовой коррекции.
